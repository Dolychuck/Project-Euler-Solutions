 ...
 * @version 12/06/2016
 *
 *Given a triangle find the maximum path from top to bottom
 *
 */
public class Number18 {
	
	public static void main(String[] args) {
		int[][] tri = { { 75 }, { 95, 64 }, { 17, 47, 82 }, { 18, 35, 87, 10 }, { 20, 4, 82, 47, 65 },
		...
		System.out.println(pyramid(tri));
	}

	/**
	 * 
	 * @param tri A triangular matrix
	 * @return The maximum path from top to bottom.
	 * This method utilizes dynamic programming.
	 */
	public static int pyramid(int[][] tri) {
